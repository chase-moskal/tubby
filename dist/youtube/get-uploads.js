...
export function getUploads(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const { channelId } = opts, options = __rest(opts
        // fetch the 'uploads' playlist for the channel
        , ["channelId"]);
        // fetch the 'uploads' playlist for the channel
        const playlistId = yield getChannelUploadsPlaylistId(Object.assign({ channelId }, options));
        // get all of the videos for that playlist
        return getPlaylistVideos(Object.assign({ playlistId }, options));
    });
}
//# sourceMappingURL=get-uploads.js.map